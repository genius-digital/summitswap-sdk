...
var Token = /*#__PURE__*/function (_Currency) {
  ...
  function Token(chainId, address, decimals, symbol, name, priority, referralEnabled, buySlippageTolerance, allowSellMax, sellSlippageTolerance) {
    var _this;
    ...
    _this.allowSellMax = allowSellMax;
...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, factoryAddress, initCodeHash) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$f = _PAIR_ADDRESS_CACHE[factoryAddress]) === null || _PAIR_ADDRESS_CACHE$f === void 0 ? void 0 : (_PAIR_ADDRESS_CACHE$f2 = _PAIR_ADDRESS_CACHE$f[tokens[0].address]) === null || _PAIR_ADDRESS_CACHE$f2 === void 0 ? void 0 : _PAIR_ADDRESS_CACHE$f2[tokens[1].address]) === undefined) {
  ...
  currentPairs, originalAmountIn, bestTrades, factory) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), factory, originalAmountIn, TradeType.EXACT_INPUT), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades, factory) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), factory, originalAmountOut, TradeType.EXACT_OUTPUT), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
...
//# sourceMappingURL=summitswap-sdk.esm.js.map
