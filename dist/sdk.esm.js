...
var Pair = /*#__PURE__*/function () {
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, factoryAddress, initCodeHash) {
    ...
    return getCreate2Address(factoryAddress, keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]), initCodeHash); // if (PAIR_ADDRESS_CACHE?.[tokens[0].address]?.[tokens[1].address] === undefined) {
    //   PAIR_ADDRESS_CACHE = {
    //     ...PAIR_ADDRESS_CACHE,
    //     [tokens[0].address]: {
