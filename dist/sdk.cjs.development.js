...
var pancakeSwapWETH = (_pancakeSwapWETH = {}, _pancakeSwapWETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c', 18, 'WBNB', 'Wrapped BNB'), _pancakeSwapWETH[exports.ChainId.BSCTESTNET] = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0xae13d989dac2f0debff460ac112a837c89baa7cd', 18, 'WBNB', 'Wrapped BNB'), _pancakeSwapWETH);
  ...
  currentPairs, originalAmountIn, bestTrades, pancakeFactoryAddress, pancakeInitCodeHash) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountOut.token.equals(tokenOut)) {
        sortedInsert(bestTrades, new Trade(new Route([].concat(currentPairs, [pair]), originalAmountIn.currency, currencyOut), originalAmountIn, exports.TradeType.EXACT_INPUT, isPancakeSwap), maxNumResults, tradeComparator);
  ...
  currentPairs, originalAmountOut, bestTrades, pancakeFactoryAddress, pancakeInitCodeHash) {
    ...
    for (var i = 0; i < pairs.length; i++) {
      ...
      if (amountIn.token.equals(tokenIn)) {
        sortedInsert(bestTrades, new Trade(new Route([pair].concat(currentPairs), currencyIn, originalAmountOut.currency), originalAmountOut, exports.TradeType.EXACT_OUTPUT, isPancakeSwap), maxNumResults, tradeComparator);
      } else if (maxHops > 1 && pairs.length > 1) {
...
exports.pancakeSwapWETH = pancakeSwapWETH;
